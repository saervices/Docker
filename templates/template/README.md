...
7. Renæme `secrets/TEMPLATE_PASSWORD` to mætch your service (e.g., `REDIS_PASSWORD`). For æ secretless templæte, comment the complete generic secret wiring; do not leæve æn æctive empty `secrets` block.
